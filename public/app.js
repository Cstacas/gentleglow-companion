    ...
    if (type === 'plant') {
      ...
      if (accessoryOverlay) {
        if (accessory !== 'none') {
          ...
          const offsets = {
            dog: {
              party: { left: '72%', top: '62px' },
              detective: { left: '72%', top: '71px' }, // Aligned to head line
              glasses: { left: '78%', top: '82px' },
              bowtie: { left: '64%', top: '96px' },
              scarf: { left: '64%', top: '96px' }
            },
            cat: {
              party: { left: '28%', top: '56px' },
              detective: { left: '28%', top: '65px' }, // Aligned to head line
              glasses: { left: '22%', top: '76px' },
              bowtie: { left: '36%', top: '92px' },
              scarf: { left: '36%', top: '92px' }
            },
            rabbit: {
              party: { left: '28%', top: '72px' },
              detective: { left: '28%', top: '81px' }, // Aligned to head line
              glasses: { left: '22%', top: '90px' },
              bowtie: { left: '36%', top: '106px' },
              scarf: { left: '36%', top: '106px' }
            },
            fox: {
              party: { left: '72%', top: '60px' },
              detective: { left: '72%', top: '69px' }, // Aligned to head line
              glasses: { left: '78%', top: '80px' },
              bowtie: { left: '64%', top: '94px' },
              scarf: { left: '64%', top: '94px' }
            },
            parrot: {
              party: { left: '28%', top: '48px' },
              detective: { left: '28%', top: '57px' }, // Aligned to head line
              glasses: { left: '22%', top: '68px' },
              bowtie: { left: '36%', top: '84px' },
              scarf: { left: '36%', top: '84px' }
            },
            turtle: {
              party: { left: '28%', top: '90px' },
              detective: { left: '28%', top: '99px' }, // Aligned to head line
              glasses: { left: '22%', top: '106px' },
              bowtie: { left: '36%', top: '118px' },
              scarf: { left: '36%', top: '118px' }
            },
            panda: {
              party: { left: '50%', top: '60px' },
              detective: { left: '50%', top: '69px' }, // Aligned to head line
              glasses: { left: '50%', top: '78px' },
              bowtie: { left: '50%', top: '96px' },
              scarf: { left: '50%', top: '96px' }
            },
            ghost: {
              party: { left: '50%', top: '44px' },
              detective: { left: '50%', top: '53px' }, // Aligned to head line
