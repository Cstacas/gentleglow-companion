          ...
          if (pType === 'dog') {
            ...
            if (breedClean === 'egypt') {
              ...
              if (accessory === 'party' || accessory === 'detective') {
                ...
                topVal = accessory === 'party' ? '36px' : '45px'; // Raised 10px higher
              } else if (accessory === 'glasses') {
              ...
              if (accessory === 'party' || accessory === 'detective') {
                leftVal = '72%'; // Right facing head
                topVal = accessory === 'party' ? '42px' : '51px'; // Raised 10px higher
              } else if (accessory === 'glasses') {
                leftVal = '78%'; // Right facing eyes
                topVal = '74px';
              } else {
              ...
              if (accessory === 'party' || accessory === 'detective') {
                leftVal = '72%'; // Right facing head
                topVal = accessory === 'party' ? '48px' : '57px'; // Raised 13px higher
              } else if (accessory === 'glasses') {
