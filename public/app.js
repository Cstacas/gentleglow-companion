        ...
        if (accessory !== 'none') {
          ...
          if (pType === 'dog') {
            ...
            if (breedClean === 'egypt') {
              ...
              // Standard cats (standard, calico, tiger, batman, retro, pixel) face left
              if (accessory === 'party' || accessory === 'detective') {
                leftVal = '28%';
                topVal = accessory === 'party' ? '61px' : '70px';
              } else if (accessory === 'glasses') {
                leftVal = '22%', topVal = '76px';
              } else {
                leftVal = '36%';
                topVal = '92px';
              }
