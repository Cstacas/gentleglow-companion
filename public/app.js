          ...
          if (pType === 'dog') {
            ...
            if (breedClean === 'egypt') {
              ...
              if (accessory === 'party' || accessory === 'detective') {
                ...
                topVal = '86px'; // Lowered 8px to prevent breathing bob overlap
              }
              ...
              if (accessory === 'party' || accessory === 'detective') {
                ...
                leftVal = '70%'; // Right facing neck
                topVal = '96px'; // Lowered 8px to prevent breathing bob overlap
              }
            } else {
              ...
              if (accessory === 'party' || accessory === 'detective') {
                ...
                leftVal = '70%'; // Right facing neck
                topVal = '94px'; // Lowered 8px to prevent breathing bob overlap
              }
            }
