    ...
    if (type === 'plant') {
      ...
      if (accessoryOverlay) {
        if (accessory !== 'none') {
          ...
          // Coordinate offset map for all pets and accessories
          const offsets = {
            dog: {
              party: { left: '72%', top: '67px' },      // Lowered 5px
              detective: { left: '72%', top: '76px' },  // Lowered 5px
              glasses: { left: '78%', top: '82px' },
              bowtie: { left: '64%', top: '96px' },
              scarf: { left: '64%', top: '96px' }
            },
            cat: {
              party: { left: '28%', top: '61px' },      // Lowered 5px
              detective: { left: '28%', top: '70px' },  // Lowered 5px
              glasses: { left: '22%', top: '76px' },
              bowtie: { left: '36%', top: '92px' },
              scarf: { left: '36%', top: '92px' }
            },
            rabbit: {
              party: { left: '28%', top: '77px' },      // Lowered 5px
              detective: { left: '28%', top: '86px' },  // Lowered 5px
              glasses: { left: '22%', top: '90px' },
              bowtie: { left: '36%', top: '106px' },
              scarf: { left: '36%', top: '106px' }
            },
            fox: {
              party: { left: '72%', top: '65px' },      // Lowered 5px
              detective: { left: '72%', top: '74px' },  // Lowered 5px
              glasses: { left: '78%', top: '80px' },
              bowtie: { left: '64%', top: '94px' },
              scarf: { left: '64%', top: '94px' }
            },
            parrot: {
              party: { left: '28%', top: '53px' },      // Lowered 5px
              detective: { left: '28%', top: '62px' },  // Lowered 5px
              glasses: { left: '22%', top: '68px' },
              bowtie: { left: '36%', top: '84px' },
              scarf: { left: '36%', top: '84px' }
            },
            turtle: {
              party: { left: '28%', top: '95px' },      // Lowered 5px
              detective: { left: '28%', top: '104px' }, // Lowered 5px
              glasses: { left: '22%', top: '106px' },
              bowtie: { left: '36%', top: '118px' },
              scarf: { left: '36%', top: '118px' }
            },
            panda: {
              party: { left: '50%', top: '65px' },      // Lowered 5px
              detective: { left: '50%', top: '74px' },  // Lowered 5px
              glasses: { left: '50%', top: '78px' },
              bowtie: { left: '50%', top: '96px' },
              scarf: { left: '50%', top: '96px' }
            },
            ghost: {
              party: { left: '50%', top: '49px' },      // Lowered 5px
              detective: { left: '50%', top: '58px' },  // Lowered 5px
              glasses: { left: '50%', top: '64px' },
              bowtie: { left: '50%', top: '82px' },
              scarf: { left: '50%', top: '82px' }
            }
          };
          
          // Get the offsets for current species and accessory
          const petGroup = offsets[pType] || offsets.dog;
          const config = petGroup[accessory] || { left: '50%', top: '80px' };
          
          let finalLeft = config.left;
          let finalTop = config.top;
          
          // Pug exceptions (pugs are front-facing / centered)
          if (pType === 'dog' && breedClean === 'pug') {
            finalLeft = '50%';
          }
          
          accessoryOverlay.style.left = finalLeft;
          accessoryOverlay.style.top = finalTop;
        } else {
